...
public class WebAddress {
    ...
    public static final String YANDEX_API_RASP_URL = "https://api.rasp.yandex.net/v3.0/";
    private static final String YANDEX_API_PARALLAX_KEY = "ac705998-ef1f-4c68-b387-c2b3243bdca3";

    private static final String YANDEX_API_RASP_PARAM_TIMEZONE = "&result_timezone=Europe/Moscow";
